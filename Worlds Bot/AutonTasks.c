...
void RightFiveCones()
{
  ...
  Atondrive(-32, drivepower);
  TurnPID(300, true);
  Atondrive(0.01, drivepower);
  startTask(StackAtonOneTask);
  wait1Msec(2100);
  stopTask(StackAtonOneTask);
