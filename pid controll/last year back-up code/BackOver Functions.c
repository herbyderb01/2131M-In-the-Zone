...
static float  pinchR_Kp = 0.20;
static float  pinchRRequestedValue;
static float  pinchR_Kd = 0.05;

static float  pinchL_Kp = 0.20;
static float  pinchLRequestedValue;
static float  pinchL_Kd = 0.08;
...
task pinchRController()
{
	...
	while( true )
	{
		...
		pinchRSensorCurrentValue = SensorValue[ pinchR ];
...
task pinchLController()
{
	...
	{
		// Read the sensor value and scale
		pinchLSensorCurrentValue = SensorValue[ pinchL ];
